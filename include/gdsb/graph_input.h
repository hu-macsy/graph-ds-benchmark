...
inline BinaryGraphHeaderMetaDataV3 read_binary_graph_header(std::ifstream& input)
{
    ...
    case 3:
    {
        ...
        input.read(reinterpret_cast<char*>(&meta_data), sizeof(BinaryGraphHeaderMetaDataV3));
